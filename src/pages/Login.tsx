    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <p className="text-sky-100 text-lg leading-relaxed">Access 1200+ curated questions across 30 subjects, powered by AI tutoring and smart analytics.</p>
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/register" className="text-sky-600 hover:text-sky-700 font-semibold transition-colors">Sign Up</Link>
            </p>
          </div>
        </div>
      </div>
